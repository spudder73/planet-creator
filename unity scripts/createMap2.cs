        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            for (int ii = x; ii < x + length; ii++)
            {
                for (int iii = y; iii < y + length; iii++)
                {
                    ...
                    map2[ii, iii, 0, 0] = -xRem;
                    map2[ii, iii, 0, 1] = -yRem;

                    //assign distance to top right
                    map2[ii, iii, 1, 0] = xRem2;
                    map2[ii, iii, 1, 1] = -yRem;

                    //assign distance to bottom left
                    map2[ii, iii, 2, 0] = -xRem;
                    map2[ii, iii, 2, 1] = yRem2;

                    //assign distance to bottom right
                    map2[ii, iii, 3, 0] = xRem2;
                    map2[ii, iii, 3, 1] = yRem2;
                }
            }
        }
